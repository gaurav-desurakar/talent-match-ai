...
- Added a guided Jobs workflow from New Job through scorecard approval, multi-resume intake, and Find Talent results.
...
- Added uncapped multi-resume selection, duplicate prevention, ordered batch comparisons, blind-review labels, and per-candidate evidence reports.
