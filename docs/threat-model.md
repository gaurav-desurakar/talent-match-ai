...
| Batch resource exhaustion                              | Ten-megabyte per-file upload limit, maximum five candidates per comparison, bounded text/reference fields, and independent validated workflows.                                                                                                                                           |
